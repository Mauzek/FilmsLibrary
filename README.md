...
KINORA — это веб-приложение для поиска, просмотра и изучения фильмов, построенное на современных технологиях с акцентом на производительность и пользовательский опыт.
...
![Избранное](./public/screenshots/favourAdd.png)
...
- Встроенный видеоплеер для просмотра
...
VITE_PLAYER_TOKEN=your_player_token_here
```
